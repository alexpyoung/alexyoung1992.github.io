...
<div class="resume-data container">
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-4 col-md-5">
            <a href="http://www.alexyoung.us" target="_blank">www.alexyoung.us</a><br/>
            <a href="mailto:alexphillipyoung@gmail.com" target="_blank">alexphillipyoung@gmail.com</a><br/>
            <a href="tel:19492466148">+1.949.246.6148</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-5">
            <ul>
                ...
                <li>Programming and Multimedia on the Web</li>
            </ul>
        </div>
        <div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-5 col-md-offset-0">
            <ul>
                ...
                <li>Design for User Experience</li> 
                <li>Modern Technologies of Web Development</li>
            </ul>
        </div>
        <hr class="col-xs-12" />
    </div>
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-2">
            <ul>
                <li>Built an e-commerce site on Shopify for a small-scale, food-distribution business</li>
                <li>Worked on branding and initial web design for a travel-based referral site</li>
                <li>Designed a front-end site to showcase products for a lei and flower business</li>
            </ul>
        </div>
        <hr class="col-xs-12" />
        <div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-5">
...
<div class="container-fluid container-alt">
    <?php
        ...
        $button = new Button_Blue("Alexander_Young_Resume.pdf", "Download A Copy");
